...
<div class="probootstrap-page-wrapper">
  ...
  <nav class="navbar navbar-default probootstrap-navbar">
    <div class="container">
      <div class="navbar-header">
        ...
        <a class="navbar-brand" style="background: url('<?php echo base_url('themes/_public/img/logo.jpg') ?>') no-repeat; background-size: 90px; height: 130px;" href="<?php echo base_url() ?>">CPSMI</a>
      </div>
  ...
  <section class="probootstrap-cta">
    <div class="container">
      <div class="row">
        <div class="col-md-12">
          <h2 class="probootstrap-animate" data-animate-effect="fadeInRight">Hubungi kami untuk informasi lanjut!</h2>
